    ...
    return (
        <div class="w-56 bg-base-200/40 border-r border-white/[0.04] flex flex-col shrink-0 select-none">
            ...
            <div class="px-5 pb-2 flex items-center gap-3">
                <a href="https://github.com/renzora/engine" target="_blank" class="text-base-content/20 hover:text-base-content/60 transition-colors" title="GitHub">
                    <IconBrandGithub size={16} />
                </a>
                <a href="https://youtube.com/@renzoragame" target="_blank" class="text-base-content/20 hover:text-base-content/60 transition-colors" title="YouTube">
                    <IconBrandYoutube size={16} />
                </a>
                <a href="https://discord.gg/9UHUGUyDJv" target="_blank" class="text-base-content/20 hover:text-base-content/60 transition-colors" title="Discord">
            ...
            <div class="p-3 border-t border-white/[0.04]">
                <Show when={props.config()?.logged_in}
                    fallback={
                        <button
                            class="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-xs text-base-content/40 hover:text-base-content hover:bg-white/[0.03] transition-all"
                ...
                >
                    <div class="flex items-center gap-2.5 px-3 py-1.5">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="text-[9px] text-accent font-medium">
                                {props.config()?.credit_balance ?? 0} credits
                            </div>
                        </div>
                    </div>
                </Show>
        ...
        <button
            class={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] font-medium transition-all relative overflow-hidden ${
                isActive()
                    ...
                    : 'text-base-content/50 hover:text-base-content/80 hover:bg-white/[0.03]'
            }`}
